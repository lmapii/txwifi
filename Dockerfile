...
RUN mkdir -p /go/src/github.com/lmapii/txwifi
COPY . /go/src/github.com/lmapii/txwifi

RUN CGO_ENABLED=0 go build -a -installsuffix cgo -o /go/bin/wifi /go/src/github.com/lmapii/txwifi/main.go
